...
def mclust_R(adata, num_cluster, modelNames='EEE', used_obsm='pred', random_seed=0):
    ...
    os.environ['R_USER'] = '/root/miniconda3/lib/python3.7/site-packages/rpy2'
    np.random.seed(random_seed)

    #安装mclust
    # from rpy2.robjects.packages import importr
    # utils = importr('utils')
    # utils.install_packages('mclust', repos="https://cloud.r-project.org")
    ...
    print(adata)
    print(adata.obsm)
    res = rmclust(numpy2ri.numpy2ri(adata.obsm[used_obsm]), num_cluster, modelNames, verbose=False)
