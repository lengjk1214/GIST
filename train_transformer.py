...
def test_one_branch(adata, hidden_dims=[512, 30], n_epochs=1000, lr=0.001, 
...
def test_img(adata, load_path, hidden_dims=[512, 30], 
...
@torch.no_grad()
def test_nano(opt, adata, hidden_dims=[512, 30], n_epochs=1000, lr=0.001, 
                gradient_clipping=5.,  weight_decay=0.0001, verbose=True, 
                random_seed=0, save_loss=False, save_reconstrction=False, 
                device = torch.device('cuda:0' if torch.cuda.is_available() else 'cpu'),
...
@torch.no_grad()
def test_nano_batch(opt, adata, hidden_dims=[512, 30], n_epochs=1000, lr=0.001, 
                gradient_clipping=5.,  weight_decay=0.0001, verbose=True, 
                random_seed=0, save_loss=False, save_reconstrction=False, 
                device = torch.device('cuda:0' if torch.cuda.is_available() else 'cpu'),
...
def train_nano_batch(opt, adata, hidden_dims=[512, 30], n_epochs=1000, lr=0.001,
                gradient_clipping=5.,  weight_decay=0.0001, verbose=True, 
                random_seed=0, save_loss=False, save_reconstrction=False, 
                device = torch.device('cuda:0' if torch.cuda.is_available() else 'cpu'),
                save_path='../checkpoint/trans_gene/', ncluster=7, repeat=1):
...
@torch.no_grad()
def test_nano_fov_batch(opt, adatas, model_name=None, hidden_dims=[512, 30], n_epochs=1000, lr=0.001,
                gradient_clipping=5.,  weight_decay=0.0001, verbose=True, 
                random_seed=0, save_loss=False, save_reconstrction=False, 
                device = torch.device('cuda:0' if torch.cuda.is_available() else 'cpu'),
                save_path='../checkpoint/trans_gene/', ncluster=7, repeat=1):
...
@torch.no_grad()
def test_nano_fov_ablation(opt, adatas, model_name=None, hidden_dims=[512, 30], n_epochs=1000, lr=0.001,
                gradient_clipping=5.,  weight_decay=0.0001, verbose=True, 
                random_seed=0, save_loss=False, save_reconstrction=False, 
                device = torch.device('cuda:0' if torch.cuda.is_available() else 'cpu'),
                save_path='../checkpoint/trans_gene/', ncluster=7, repeat=1,
...
def train_nano_fov_ablation(opt, adatas, hidden_dims=[512, 30], n_epochs=1000, lr=0.001, 
                gradient_clipping=5.,  weight_decay=0.0001, verbose=True, 
                random_seed=0, save_loss=False, save_reconstrction=False, 
                device = torch.device('cuda:0' if torch.cuda.is_available() else 'cpu'),
                save_path='../checkpoint/trans_gene/', ncluster=7, repeat=1,
...
def train_nano(opt, adata, hidden_dims=[512, 30], n_epochs=1000, lr=0.001, 
                gradient_clipping=5.,  weight_decay=0.0001, verbose=True, 
                random_seed=0, save_loss=False, save_reconstrction=False, 
                device = torch.device('cuda:0' if torch.cuda.is_available() else 'cpu'),
                save_path='../checkpoint/trans_gene/', ncluster=7, repeat=1):
...
def train_one_branch(adata, hidden_dims=[512, 30], n_epochs=1000, lr=0.001, 
                gradient_clipping=5.,  weight_decay=0.0001, verbose=True, 
                random_seed=0, save_loss=False, save_reconstrction=False, 
                device = torch.device('cuda:0' if torch.cuda.is_available() else 'cpu'),
                save_path='../checkpoint/trans_gene/', ncluster=7, repeat=1, use_img_loss=0, use_combine=1,
...
def train_img(adata, hidden_dims=[512, 30], n_epochs=1000, lr=0.001, 
                gradient_clipping=5.,  weight_decay=0.0001, verbose=True, 
                random_seed=0, save_loss=False, save_reconstrction=False, 
                device = torch.device('cuda:0' if torch.cuda.is_available() else 'cpu'),
                save_path='../checkpoint/trans_gene/',result_path='../result/trans_gene/', ncluster=7, repeat=1, use_img_loss=0, use_combine=1,
                X_train_idx=None, X_test_idx=None, lambda_1 = 1, lambda_2 = 1, lambda_3 = 1):
    # seed_everything(random_seed)
    ...
    with torch.no_grad():
        ...
        ax = sc.pl.umap(adata_Vars, color=['Ground Truth'], show=False, title='combined latent variables')
        plt.savefig(os.path.join(result_path, 'umap_final.pdf'), bbox_inches='tight')
...
def train_10x_all(adatas, hidden_dims=[512, 30], n_epochs=1000, lr=0.001, 
                gradient_clipping=5.,  weight_decay=0.0001, verbose=True, 
                random_seed=0, save_loss=False, save_reconstrction=False, 
                device = torch.device('cuda:0' if torch.cuda.is_available() else 'cpu'),
                save_path='../checkpoint/trans_gene/', ncluster=7, repeat=1, use_img_loss=0, use_combine=1,
...
def test_10x_all(adatas, hidden_dims=[512, 30], n_epochs=1000, lr=0.001, 
                gradient_clipping=5.,  weight_decay=0.0001, verbose=True, 
                random_seed=0, save_loss=False, save_reconstrction=False, 
                device = torch.device('cuda:0' if torch.cuda.is_available() else 'cpu'),
                save_path='../checkpoint/trans_gene/', ncluster=7, repeat=1, use_img_loss=0, use_combine=1,
